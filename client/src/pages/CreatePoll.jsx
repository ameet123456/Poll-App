...
import { Plus, X, Calendar, Eye, EyeOff, Share2, Copy, Check } from "lucide-react";
...
export default function CreatePoll() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6 flex items-center justify-center">
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Poll Created Successfully!</h2>
          <p className="text-gray-600">Share these links with your audience</p>
        </div>
  ...
  copyToClipboard(
    ...
    "voter"
            ...
            <p className="text-sm text-gray-600 mt-2">Share this link with voters</p>
          </div>
    ...
    <div className="min-h-screen bg-white p-6">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8 pt-8">
          <h1 className="text-4xl font-bold text-black mb-2">Create Your Poll</h1>
          <p className="text-gray-600">Gather opinions and feedback in real-time</p>
        </div>
            ...
            <div className="bg-gray-50 rounded-xl p-4 border-2 border-black">
              <label className="flex items-center justify-between cursor-pointer">
                <div className="flex items-center gap-3">
                  {showResults ? <Eye className="w-5 h-5 text-black" /> : <EyeOff className="w-5 h-5 text-gray-400" />}
                  <div>
                    <div className="font-semibold text-black">Show Live Results</div>
                    <div className="text-sm text-gray-600">Allow voters to see results after voting</div>
                  </div>
                </div>
            ...
            <div className="bg-gray-50 rounded-xl p-4 border-2 border-black">
              <label className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="font-semibold text-black mb-2">End Date (Optional)</div>
                  <input
                    type="datetime-local"
                    value={endTime}
